...
<?php require_once 'templates/header.tpl.php'; ?>
    <div class="container">
        ...
        <div class="error"><span class="fa fa-exclaimation-triangle"></span> You didn't fill the form out corretly. <div>
    <?php endif; ?>
    ...
    <form action="../controllers/routes.php?action=create" method="post">
        ...
        <input type="number" name="balance" value="" id="balance">
        ...
        <button type="submit"><span class="fa fa-plus"></span> Add People</button>
    </form>
    </div>
